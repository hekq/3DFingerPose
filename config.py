...
_C.MODEL.YAW_MAX = 90
_C.MODEL.YAW_MIN = -90
_C.MODEL.PITCH_MAX = 0
_C.MODEL.PITCH_MIN = -90
_C.MODEL.ROLL_MAX = 90
_C.MODEL.ROLL_MIN = -90
...
def _update_config_from_file(config, cfg_file):
    if cfg_file and cfg_file!='' and os.path.exists(cfg_file):
        config.defrost()
